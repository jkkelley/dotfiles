...
|---|---|---|---|---|
| `WO-20260824-0615` | ready | p1 | - | [Confirm whether a SessionStart hook matcher filters by source](WO-20260824-0615-confirm-whether-a-sessionstart-hook-matcher-filt.md) |
...
| `WO-20260824-360d` | ready | p1 | WO-20260824-cc71 WO-20260824-efb0 | [Publish workflow: allocate versions on merge to main and regenerate the registry](WO-20260824-360d-publish-workflow-allocate-versions-on-merge-to-m.md) |
...
| `WO-20260824-cc71` | in-progress | p1 | - | [Repo settings: squash-only, with the commit body taken from the PR description](WO-20260824-cc71-repo-settings-squash-only-with-the-commit-body-t.md) |
