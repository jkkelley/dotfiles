...
| `WO-20260824-de9e` | done | p1 | - | [Registry schema 2, with type derived from the tree and requires read from frontmatter](WO-20260824-de9e-registry-schema-2-with-type-derived-from-the-tre.md) |
...
| `WO-20260824-5b89` | ready | p1 | WO-20260824-2136 | [skill-sync.sh part one: resolution, and the tools test tree it is proved in](WO-20260824-5b89-skill-sync-sh-part-one-resolution-and-the-tools-.md) |
