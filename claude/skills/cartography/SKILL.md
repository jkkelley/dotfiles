...
> Upstream is `~/dotfiles/claude/skills/cartography/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/cartography if that checkout is not on this machine.
