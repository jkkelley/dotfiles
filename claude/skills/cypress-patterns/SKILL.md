...
> Upstream is `~/dotfiles/claude/skills/cypress-patterns/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/cypress-patterns if that checkout is not on this machine.
