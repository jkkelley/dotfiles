...
> Upstream is `~/dotfiles/claude/skills/task-router/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/task-router if that checkout is not on this machine.
