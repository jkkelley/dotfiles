...
> Upstream is `~/dotfiles/claude/skills/test-writer/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/test-writer if that checkout is not on this machine.
