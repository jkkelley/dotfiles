...
> Upstream is `~/dotfiles/claude/skills/kubectl-runbook/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/kubectl-runbook if that checkout is not on this machine.
