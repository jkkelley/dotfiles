...
> Upstream is `~/dotfiles/claude/skills/api-design-checklist/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/api-design-checklist if that checkout is not on this machine.
