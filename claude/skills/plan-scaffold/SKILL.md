...
> Upstream is `~/dotfiles/claude/skills/plan-scaffold/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/plan-scaffold if that checkout is not on this machine.
