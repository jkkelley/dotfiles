...
> Upstream is `~/dotfiles/claude/skills/web-scraping-guru/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/web-scraping-guru if that checkout is not on this machine.
