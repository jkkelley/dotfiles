...
> Upstream is `~/dotfiles/claude/skills/operator/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/operator if that checkout is not on this machine.
