...
> Upstream is `~/dotfiles/claude/skills/frontend-checklist/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/frontend-checklist if that checkout is not on this machine.
