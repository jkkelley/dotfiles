...
> Upstream is `~/dotfiles/claude/skills/project-kickoff/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/project-kickoff if that checkout is not on this machine.
