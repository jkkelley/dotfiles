...
> Upstream is `~/dotfiles/claude/skills/argocd-runbook/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/argocd-runbook if that checkout is not on this machine.
