...
> Upstream is `~/dotfiles/claude/skills/jenkins-job-bootstrap/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/jenkins-job-bootstrap if that checkout is not on this machine.
