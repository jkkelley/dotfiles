...
> Upstream is `~/dotfiles/claude/skills/jenkinsfile-snippets/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/jenkinsfile-snippets if that checkout is not on this machine.
