...
> Upstream is `~/dotfiles/claude/skills/screenshot-syncer/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/screenshot-syncer if that checkout is not on this machine.
