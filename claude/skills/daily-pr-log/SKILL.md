...
> Upstream is `~/dotfiles/claude/skills/daily-pr-log/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/daily-pr-log if that checkout is not on this machine.
