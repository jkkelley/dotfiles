...
> Upstream is `~/dotfiles/claude/skills/terraform-patterns/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/terraform-patterns if that checkout is not on this machine.
