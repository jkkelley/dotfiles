...
> Upstream is `~/dotfiles/claude/skills/git-review-checklist/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/git-review-checklist if that checkout is not on this machine.
