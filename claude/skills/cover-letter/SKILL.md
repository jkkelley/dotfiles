...
> Upstream is `~/dotfiles/claude/skills/cover-letter/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/cover-letter if that checkout is not on this machine.
