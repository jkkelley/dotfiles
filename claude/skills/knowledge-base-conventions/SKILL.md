...
> Upstream is `~/dotfiles/claude/skills/knowledge-base-conventions/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/knowledge-base-conventions if that checkout is not on this machine.
