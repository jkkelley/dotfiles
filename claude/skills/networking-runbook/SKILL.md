...
> Upstream is `~/dotfiles/claude/skills/networking-runbook/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/networking-runbook if that checkout is not on this machine.
