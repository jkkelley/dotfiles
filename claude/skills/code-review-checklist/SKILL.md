...
> Upstream is `~/dotfiles/claude/skills/code-review-checklist/`, or https://github.com/jkkelley/dotfiles/tree/main/claude/skills/code-review-checklist if that checkout is not on this machine.
